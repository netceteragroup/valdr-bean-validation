...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
  ...
  /**
   * Create a new, empty {@link com.github.valdr.util.AnnotationAttributes} instance.
   */
  public AnnotationAttributes() {
  }

  /**
   * Create a new, empty {@link com.github.valdr.util.AnnotationAttributes} instance with the given initial
  ...
  /**
   * Create a new {@link com.github.valdr.util.AnnotationAttributes} instance, wrapping the provided map
  ...
  /**
   * Return an {@link com.github.valdr.util.AnnotationAttributes} instance based on the given map; if the map
